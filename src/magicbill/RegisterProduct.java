...
public class RegisterProduct extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(67, 131, 188));
        ...
        jLabel6.setText("Unit Price (INR)*");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "GST rate 3 %", "GST rate 5 %", "GST rate 12 %", "GST rate 18 %", "GST rate 28 %" }));
        ...
        setSize(new java.awt.Dimension(562, 527));
    ...
    private void insertIntoTable() {
        try (Connection con = ActionDao.getDBConnection()) {
            ...
            String HSN = jTextField2.getText();
            Double price = Double.valueOf(jTextField3.getText());
            Integer quantity = Integer.parseInt(jTextField4.getText());
            Double tax = Double.valueOf(jComboBox1.getSelectedItem().toString().split(" ")[2]);
            if (name != null && !name.isEmpty() && price != null && quantity != null && tax != null) {
                String query = "INSERT INTO PRODUCTDETAIL (PRODUCTNAME, HSN, DESCRIPTION, PRICE, QUANTITY, TAX) "
                        + "VALUES (?, ?, ?, ?, ?, ?)";
